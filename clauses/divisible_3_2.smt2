...
(assert
  (not (exists ( (|$alpha-3:n| Int) (|$knormal:11| Int) (|$knormal:13| Int) (|$knormal:15| Int) (|$knormal:17| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    ( and (= |$knormal:9| 3) (= (not (= 0 |$knormal:7|)) (>= |$alpha-3:n| 0)) (= |$knormal:15| 2) (= (not (= 0 |$knormal:13|)) (and (not (= 0 |$knormal:11|)) (not (= 0 |$knormal:7|)))) (not (not (= 0 |$knormal:17|))) (not (= 0 |$knormal:13|)) (|divisible$u3| |$knormal:17| |$knormal:15| |$alpha-3:n|) (|divisible$u3| |$knormal:11| |$knormal:9| |$alpha-3:n|) )
    )
  )
)
(assert
  (forall ( (|$alpha-3:n| Int) (|$knormal:11| Int) (|$knormal:13| Int) (|$knormal:15| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    (=>
      ( and (= |$knormal:9| 3) (= (not (= 0 |$knormal:7|)) (>= |$alpha-3:n| 0)) (= |$knormal:15| 2) (= (not (= 0 |$knormal:13|)) (and (not (= 0 |$knormal:11|)) (not (= 0 |$knormal:7|)))) (not (= 0 |$knormal:13|)) (|divisible$u3| |$knormal:11| |$knormal:9| |$alpha-3:n|) )
      true
    )
  )
)
...
(assert
  (forall ( (|$alpha-3:n| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    (=>
      ( and (= |$knormal:9| 3) (= (not (= 0 |$knormal:7|)) (>= |$alpha-3:n| 0)) )
      true
    )
  )
)
